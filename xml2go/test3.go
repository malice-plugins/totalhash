...
var filename = "/Users/user/src/go/src/github.com/maliceio/malice-totalhash/410913302455e646f5e3205534208fdcfda6d9c8.xml"
...
type Chidns struct {
	Attr_ip string `xml:" ip,attr"  json:",omitempty"`
...
type Chiflows struct {
	Attr_bytes string `xml:" bytes,attr"  json:",omitempty"`
	Attr_dst_ip string `xml:" dst_ip,attr"  json:",omitempty"`
	Attr_dst_port string `xml:" dst_port,attr"  json:",omitempty"`
	Attr_protocol string `xml:" protocol,attr"  json:",omitempty"`
	Attr_src_ip string `xml:" src_ip,attr"  json:",omitempty"`
	Attr_src_port string `xml:" src_port,attr"  json:",omitempty"`
}
...
type Chinetwork_pcap struct {
	...
	Chiflows []*Chiflows `xml:" flows,omitempty" json:"flows,omitempty"`
}
