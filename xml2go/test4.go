...
var filename = "/Users/user/src/go/src/github.com/maliceio/malice-totalhash/4af607a4ecf7885018ab5a788e8f0607b4fcb08b.xml"
...
type Chicalltree struct {
	Chiprocess_call []*Chiprocess_call `xml:" process_call,omitempty" json:"process_call,omitempty"`
}
...
type Chicreate_process struct {
	Attr_apifunction string `xml:" apifunction,attr"  json:",omitempty"`
	Attr_cmdline string `xml:" cmdline,attr"  json:",omitempty"`
	Attr_targetpid string `xml:" targetpid,attr"  json:",omitempty"`
}

type Chidelete_file struct {
	Attr_filetype string `xml:" filetype,attr"  json:",omitempty"`
	Attr_srcfile string `xml:" srcfile,attr"  json:",omitempty"`
}
...
type Chidns struct {
	Attr_rr string `xml:" rr,attr"  json:",omitempty"`
...
type Chifilesystem_section struct {
	...
	Chidelete_file []*Chidelete_file `xml:" delete_file,omitempty" json:"delete_file,omitempty"`
}

type Chigetaddrinfo struct {
	Attr_requested_host string `xml:" requested_host,attr"  json:",omitempty"`
}
...
type Chiimports struct {
	Attr_dll string `xml:" dll,attr"  json:",omitempty"`
}
...
type Chinetwork_pcap struct {
	Attr_md5 string `xml:" md5,attr"  json:",omitempty"`
	Attr_sha1 string `xml:" sha1,attr"  json:",omitempty"`
	Chidns *Chidns `xml:" dns,omitempty" json:"dns,omitempty"`
}

type Chiopen_process struct {
	Attr_apifunction string `xml:" apifunction,attr"  json:",omitempty"`
	Attr_targetpid string `xml:" targetpid,attr"  json:",omitempty"`
}
...
type Chiprocess struct {
	Attr_executionstatus string `xml:" executionstatus,attr"  json:",omitempty"`
	Attr_filename string `xml:" filename,attr"  json:",omitempty"`
	...
	Chiprocess_section *Chiprocess_section `xml:" process_section,omitempty" json:"process_section,omitempty"`
	Chiregistry_section *Chiregistry_section `xml:" registry_section,omitempty" json:"registry_section,omitempty"`
	Chiwindows_hook_section *Chiwindows_hook_section `xml:" windows_hook_section,omitempty" json:"windows_hook_section,omitempty"`
	Chiwinsock_section *Chiwinsock_section `xml:" winsock_section,omitempty" json:"winsock_section,omitempty"`
}

type Chiprocess_call struct {
	Attr_filename string `xml:" filename,attr"  json:",omitempty"`
	Attr_index string `xml:" index,attr"  json:",omitempty"`
	Attr_pid string `xml:" pid,attr"  json:",omitempty"`
	Attr_startreason string `xml:" startreason,attr"  json:",omitempty"`
}

type Chiprocess_section struct {
	Chicreate_process *Chicreate_process `xml:" create_process,omitempty" json:"create_process,omitempty"`
	Chiopen_process []*Chiopen_process `xml:" open_process,omitempty" json:"open_process,omitempty"`
}
...
type Chiset_windows_hook struct {
	Attr_hook_address string `xml:" hook_address,attr"  json:",omitempty"`
	Attr_hookid string `xml:" hookid,attr"  json:",omitempty"`
	Attr_threadid string `xml:" threadid,attr"  json:",omitempty"`
}
...
type Chistatic struct {
	...
	Chiimports *Chiimports `xml:" imports,omitempty" json:"imports,omitempty"`
...
type Chiwindows_hook_section struct {
	Chiset_windows_hook *Chiset_windows_hook `xml:" set_windows_hook,omitempty" json:"set_windows_hook,omitempty"`
}

type Chiwinsock_section struct {
	Chigetaddrinfo *Chigetaddrinfo `xml:" getaddrinfo,omitempty" json:"getaddrinfo,omitempty"`
}
